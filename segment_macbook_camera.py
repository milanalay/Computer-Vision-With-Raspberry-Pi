...
def run(model_name, display_mode, width, height):
    # Initialize the image segmentation model
    segmenter = segment_project_module.ImageSegmenter(model_name, segment_project_module._NUM_THREADS)
...
def main():
    ...
    run(args.model, args.displayMode, args.frameWidth, args.frameHeight)
